...
import dmtaclasses.dmtaclasses as dataclasses   # Needed for the string "dataclasses.InitVar[int]" to work as an annotation.
...
class TestStringAnnotations(unittest.TestCase):
    ...
    def test_classvar_module_level_import(self):
        from test_dmtaclasses import dataclass_module_1
        from test_dmtaclasses import dataclass_module_1_str
        from test_dmtaclasses import dataclass_module_2
        from test_dmtaclasses import dataclass_module_2_str
    ...
    def test_text_annotations(self):
        from test_dmtaclasses import dataclass_textanno
